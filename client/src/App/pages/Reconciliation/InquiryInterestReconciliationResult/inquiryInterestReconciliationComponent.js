...
class InquiryInterestReconciliationComponent extends Component {
    constructor(props) {
        super(props);
        this.state = {
            date_interest: "",
            ...
            .then(data => {
                if (data) {
                    this.setState({
                        isFound: true,
                        loading: false,
                        dateRes: data.rs_body.interest_reconciliation_list
                    });
                    //  utility.clearSessionStorage("response_inquiryInterest");
    ...
    render() {
        ...
        return (
            <div>
                <DynamicHeader />
                <h2>Form Input Inquiry Interest Reconciliation Result</h2>
                <Container>
                    <Row>
...
export default InquiryInterestReconciliationComponent;