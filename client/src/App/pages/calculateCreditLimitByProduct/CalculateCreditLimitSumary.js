...
class CalculateCreditLimitByProductSummary extends Component {
    constructor(props) {
        super(props);
        this.state = {};
    };
    ...
    render() {
        const data = JSON.parse(sessionStorage.getItem("response_calculateCreditLimitByProduct"));
        //console.log(data);
        return (
            <div className="App">
                <DynamicHeader/>
                <Form>
                    <h2>Form Data Calculate Credit Limit and Review Date by Product</h2>
...
export default CalculateCreditLimitByProductSummary;
