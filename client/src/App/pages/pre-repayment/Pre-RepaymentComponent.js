...
class PreRepaymentComponent extends Component {
    constructor(props) {
        super(props);
        this.state = {
            rq_body: {
    ...
    render() {
        ...
        return (
            <div>
                <DynamicHeader/>
                <h2>Form Input Pre-Repayment</h2>
                <Container>
                    <Row>
...
export default PreRepaymentComponent;
